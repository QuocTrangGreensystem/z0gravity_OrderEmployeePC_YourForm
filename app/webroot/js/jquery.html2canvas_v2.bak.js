    ...
    Gantt = {
        ...
        */
        ...
        draw : function(x1,y1,x2,y2){
            ...
            {
                this.sline(x1,y1,x1+4,y1);
                this.sline(x1+4,y1,x1+4,y2-20);
                this.sline(x1+4,y2-20,x2-8,y2-20);
                this.sline(x2-8,y2-20,x2-8,y2);
        ...
        init : function(){
            ...
            var xp = this.doc.find('.gantt-line-n:first').height() / 2 ;
            this.doc.find('.gantt-line div[rel]').each(function(){
                ...
                if($des.length){
                    ...
                    Gantt.draw(d1.left+x1.left + $des.width(), d1.top + x1.top + xp, d2.left+x2.left, d2.top+x2.top + xp);
                }
            });
        }
    }

...
(function( $ ){
    ...
    Gantt = {
        ...
        */
        ...
        rdraw : function(){
            this.doc = $('#AjaxGanttChartDIV .gantt-chart-wrapper');
    ...
    $(function(){
        ...
        $('#AjaxGanttChartDIV .gantt-line .gantt-msi').each(function(){
            var $element = $(this);
        ...
        $('#AjaxGanttChartDIV .gantt-ms .gantt-line').height(stack.length * height );
        $('#ExportRows').val(Number($('#ExportRows').val()) + stack.length);
        
        var $wrapper = $('#AjaxGanttChartDIV');
        ...
        $wrapper.find('.gantt-chart-wrapper').prepend($gantt);
        var timeoutID;

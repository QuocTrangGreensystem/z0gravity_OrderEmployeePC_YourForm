...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function appendRowHtml(stringArray, row) {
      ...
      var idRow = d && d.id ? d.id : '';
      stringArray.push("<div id='row-" + idRow + "' class='ui-widget-content " + rowCss + "' style='top:" + (options.rowHeight * row - offset) + "px'>");
    ...
    function getViewportHeight() {
      var he = parseFloat($.css($container[0], "height", true)) -
      ...
      var _h;
      if(wdTable.length != 0){
        _h = $(window).height() - wdTable.offset().top - 120;
      } else _h = he;

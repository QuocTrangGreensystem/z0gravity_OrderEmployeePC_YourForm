    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function applyColumnWidths() {
            ...
            for (var i = 0; i < columns.length; i++) {
                ...
                // HuuPC: SL 2.0: rule.right.style.right = (canvasWidth - x - w) + "px";
        ...
        function scrollTo(y) {
            y = Math.max(y, 0);
            //HuuPC: SL 2.0: y = Math.min(y, th - viewportH + (viewportHasHScroll ? scrollbarDimensions.height : 0));
        ...
        function removeRowFromCache(row) {
            ...
            //HuuPC: SL 2.0: $canvas[0].removeChild(cacheEntry.rowNode);
        ...
        */
        ...
        function handleContextMenu(e) {
            ...
            //trigger(self.onContextMenu, {}, e); // 2.2
            trigger(self.onContextMenu, {record: e}, e); // 2.0
        }
      ...
      if (activeCellChanged) {
        ...
        */        
        ...
        $.extend(this, {
            ...
            //"onHeaderRendered": new Slick.Event(), // 2.0
            //"onBeforeHeaderDestroy": new Slick.Event(), // 2.0            
            ...
            //"applyColumnHeaderWidths": applyColumnHeaderWidths, //2.0
            //"applyColumnWidths": applyColumnWidths //2.0            
        });

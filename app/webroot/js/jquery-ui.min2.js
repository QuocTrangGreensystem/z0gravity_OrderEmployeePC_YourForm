                ...
                for (var L = 0; L < k[1]; L++) {
                    ...
                    for (var R = 0; R < G; R++) {
                        ...
                        for (B = 0; B < 7; B++) {
							...
							var _date = A.getDate(), _month = A.getMonth()+1, _year = A.getFullYear();
							if( _month < 10 )_month = '0' + _month;
							var theDate = $.datepicker.formatDate('yy-mm-dd', A), _cls = '';
                            if( b.settings.highlights ){
    							if( $.inArray(theDate, b.settings.highlights.days) > -1 ){
    								_cls = 'date-highlighted';
                                    if( b.settings.highlights.repeat[theDate] ){
                                        _cls += ' date-repeat';
                                    }
    							}
    							else _cls = '';
                            }
                            S += '<td data-time="' + theDate + '" data-month="' + _month + '" data-date="' + _date + '" data-year="' + _year + '" class="date-' + theDate + ' ' + _cls + ' ' + ((B + n + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (K ? " ui-datepicker-other-month" : "") + (A.getTime() ==

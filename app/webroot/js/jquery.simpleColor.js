		...
		select_button.bind('click', {
			...
			function (event) {
				...
				// Build the chooser
					...
					chooser.css('margin-top',  '2px');
					chooser.css('width',   '342px');
					chooser.css('height',  '80px');
					...
					for (var i=0; i<options.colors.length; i++) {
						...
						cell.bind('click', {
							...
							function(event) {
                                ...
                                $("#color_1").css('backgroundColor', '#' + this.id);
                                $("#color_value").val('#' + this.id);
                                //$("#color_1").text('#' + this.id);

...
if(jQuery) (function($){
    ...
    function renderOption(id, option, o)
    {
        ...
        var html = '<label><input '+ atrRel +' type="checkbox"  name="' + id + '[]" value="' + option.value + '" id="' + id + '-check-' + option.value + '"';
        if( option.selected ){
    ...
    function updateSelected(eventKey) {
        ...
        multiSelectOptions.find('INPUT:checkbox').not('.selectAll, .optGroup').each( function() {
            if( $(this).prop('checked') ) {
                ...
                display = display + '<i class="selected-item" data-id="' + $(this).val() + '">' + $(this).parent().text() + '</i>, ';
            }
        ...
        if( i == 0 ) {
            ...
            if( o.oneOrMoreSelected == '*' ) {
                ...
                multiSelect.prop( "title", title_display );
            } else {
                ...
                if(option.update=='#ActivityActivityEmployee' || option.update=='#export-list-employees' )
                {
                    ...
                    if(result)
                    {
                        ...
                        $.each(pc, function($index, $pc)
                        {
                            ...
                            $parent.find('div label').find('input[value="' + $pc + '"]').prop('checked','checked');

 ...
 */
class ProjectStaffingsPreviewController extends AppController {
     ...
     * @access public
     */
    var $name = 'ProjectStaffingsPreview';
     ...
     * @access public
     */
    var $helpers = array('Gantt', 'GanttSt','GanttV2','GanttV3Preview');
    /**
     * Vision gantt chart
     *
     * @return void
...
// debug(date('h:m:s', time()));
       ...
       $this->loadModel('HistoryFilter');
        ...
        $this->set(compact('phasePlans', 'display', 'project_id', 'parts', 'staffingss', 'showType', 'minMax', 'employee_info', 'budgetMdTeams', 'freezeTeams', 'displayTeamPlus'));
        // pr($staffingss);
        // die;

 ...
 */
class AgentParser {
	public static function getBrowserInfo( $u_agent = null ) {
		if( is_null($u_agent) ) {
		...
		return array( 'platform' => $platform ? $platform : 'Unknown', 'name' => $browser ? $browser : 'Unknown', 'version' => $version ? $version : '', 'userAgent' => $u_agent );
	}
}

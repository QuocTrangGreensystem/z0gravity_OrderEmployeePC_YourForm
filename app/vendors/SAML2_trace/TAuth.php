...
class OneLogin_Saml2_TAuth
{
    ...
    public function add_error_logs($logs){
        $this->_trace_log = array_merge($this->_trace_log,$logs);
    }
    ...
    public function processResponse($requestId = null)
    {
        ...
        if (isset($_POST['SAMLResponse'])) {
            ...
            $response = new OneLogin_Saml2_TResponse($this->_settings, $_POST['SAMLResponse']);
            ...
            $this->add_error_logs($response->get_log());

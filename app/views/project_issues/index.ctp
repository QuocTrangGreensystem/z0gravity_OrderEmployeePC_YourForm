        ...
        <div class="wd-main-content">
            ...
            <div class="wd-list-project">
                <div class="wd-title">
                    ...
                    <a href="javascript:void(0);" class="btn btn-plus-green" id="add-new-sales" style="margin-right:5px;" onclick="addNewIssueButton();" title="<?php __('Add an item') ?>"></a>
                ...
                <div class="group-content">
                    ...
                    <h3 class="half-padding">
                        <span><a href="javascript:void(0);" id="add-activity" class="new_log" onclick="addLog('#pi-log')"></a></span>
                    </h3>
                    <?php endif;?>
                    <div id="pi-log" class="kpi-log">
                        <ul>
                            ...
                            ?>
                            <li id="pi-<?php echo $logSystem['id'] ?>" data-log-id="<?php echo $logSystem['id'] ?>">
                                ...
                                <div class="log-body">
                                    ...
                                    <textarea class="log-content" rowspan="2" onfocus="autosize(this)" onblur="autosize.destroy(this)" <?php echo $checkIsChang !== 'true' ? 'disabled' : '' ?> onchange="updateLog.call(this, 'ProjectIssue')"><?php echo $logSystem['description'] ?></textarea>
                                </div>
                            </li>
                            <?php
                                    }

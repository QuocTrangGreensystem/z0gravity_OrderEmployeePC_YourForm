<div class="projectAmrSubCategories view">
<h2><?php  __('Project Amr Sub Category');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrSubCategory['ProjectAmrSubCategory']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Sub Category'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrSubCategory['ProjectAmrSubCategory']['amr_sub_category']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Sub Category', true), array('action' => 'edit', $projectAmrSubCategory['ProjectAmrSubCategory']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Sub Category', true), array('action' => 'delete', $projectAmrSubCategory['ProjectAmrSubCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrSubCategory['ProjectAmrSubCategory']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Sub Categories', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Sub Category', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrSubCategory['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrSubCategory['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

...
<?php
	...
	$columns = array(
		...
		'amr_sub_category' => array(
			'id' => 'amr_sub_category',
			'field' => 'amr_sub_category',
			'name' => __('AMR Sub Category', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
			'editor' => 'Slick.Editors.textBox'
		),
		'project_amr_category_id' => array(
			'id' => 'project_amr_category_id',
			'field' => 'project_amr_category_id',
			'name' => __('Project AMR Category', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$selectMaps = array(
		...
		'project_amr_category_id' => $displayAMRCategory
	);
	
	$dataView = array();
	$i = 1;
	foreach ($projectAmrSubCategories as $ProjectAmrSubCategory){
		if ($ProjectAmrSubCategory['ProjectAmrCategory']['company_id'] != "") {
			$company_id_save = $ProjectAmrSubCategory['ProjectAmrCategory']['company_id'];
		...
		$row_data = array(
			'id' => $ProjectAmrSubCategory['ProjectAmrSubCategory']['id'],
			'no' => $i++,
			'amr_sub_category' => $ProjectAmrSubCategory['ProjectAmrSubCategory']['amr_sub_category'],
			'project_amr_category_id' => $ProjectAmrSubCategory['ProjectAmrCategory']['amr_category'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_sub_category : {defaulValue : '', allowEmpty : false},
				project_amr_category_id : {defaulValue : '', allowEmpty : false},

...
<?php
	...
	$dataView = array();
	$i = 1;
	foreach ($projectIssueSeverities as $projectIssueSeverity){
		if ($projectIssueSeverity['ProjectIssueSeverity']['company_id'] != "") {
			$company_id_save = $projectIssueSeverity['ProjectIssueSeverity']['company_id'];
		...
		$row_data = array(
			'id' => $projectIssueSeverity['ProjectIssueSeverity']['id'],
			'no' => $i++,
			'issue_severity' => $projectIssueSeverity['ProjectIssueSeverity']['issue_severity'],
			'color' => $projectIssueSeverity['ProjectIssueSeverity']['color'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				issue_severity : {defaulValue : '', allowEmpty : false},

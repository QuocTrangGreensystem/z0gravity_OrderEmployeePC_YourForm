<div class="projectIssueSeverities view">
<h2><?php  __('Project Issue Severity');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectIssueSeverity['ProjectIssueSeverity']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Issue Severity'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectIssueSeverity['ProjectIssueSeverity']['issue_severity']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Issue Severity', true), array('action' => 'edit', $projectIssueSeverity['ProjectIssueSeverity']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Issue Severity', true), array('action' => 'delete', $projectIssueSeverity['ProjectIssueSeverity']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectIssueSeverity['ProjectIssueSeverity']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Issue Severities', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Issue Severity', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectIssueSeverity['ProjectIssue'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectIssueSeverity['ProjectIssue'] as $projectIssue):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

...
<div id="dialog_attachement_or_url" class="buttons" style="display: none;">
    <fieldset>
        ...
        echo $this->Form->create('Upload', array(
                ...
                'url' => array('controller' => 'budget_customers', 'action' => 'upload')
            )); ?>
                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
                            ...
                            <div class="wd-content">
                                <h2 class="wd-t3"><?php //echo sprintf(__("Budget Customers management of %s", true), $companyName['Company']['company_name']); ?></h2>
...
foreach ($budgetCustomers as $budgetCustomer) {
    $data = array(
        'id' => $budgetCustomer['BudgetCustomer']['id'],
        'company_id' => $company_id,
        'no.' => $i++,
        'MetaData' => array()
    );
    $data['name'] = (string) $budgetCustomer['BudgetCustomer']['name'];
    $data['address'] = (string) $budgetCustomer['BudgetCustomer']['address'];
    $data['city'] = (string) $budgetCustomer['BudgetCustomer']['city'];
    $data['country'] = (string) $budgetCustomer['BudgetCustomer']['country'];
    $data['email'] = (string) $budgetCustomer['BudgetCustomer']['email'];
    $data['file_attachement'] = (string) $budgetCustomer['BudgetCustomer']['file_attachement'];
    $data['format'] = (string) $budgetCustomer['BudgetCustomer']['format'];
...
$i18n = array(
    ...
    'Clear' => __('Clear', true),
    'Attachement or URL' => __('Attachement or URL', true)
);
?>
...
<div style="display: none" id="upload-template-place">
    <div id="upload-template">
        ...
        echo $this->Form->input('attachment', array('type' => 'file', 'value' => '',
            ...
            'rel' => 'no-history'));
        echo $this->Form->input('url', array('type' => 'text', 'value' => '',
            'name' => 'FileField[url]',
            'label' => false,
            'class' => 'template-input-text',
            'rel' => 'no-history'));
        echo $this->Form->end();
        ?>
    </div>
    ...
    (function($){
        ...
        $(function(){
            ...
            DataValidator.isUnique = function(value,args){
                ...
                return {
                    valid : result,
                    message : $this.t('The budget customer has already been exist.')
                };
            }

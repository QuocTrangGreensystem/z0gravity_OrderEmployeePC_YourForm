    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            <div class="wd-list-project">
                ...
                echo $this->Form->create('Import', array('id' => 'import-form', 'url' => array('controller' => 'audit_recoms', 'action' => 'save_file_import', $company_id, $audit_mission_id)));
                ?>
                <?php 
                foreach ($records as $type => $record) : ?>
                    ...
                    <div class="import-fieldset">
                        <legend class="import-legend">
                            ...
                            switch ($type) {
                                case 'Create':
                                    echo __('New Recommendation', true);
                                    break;
                                case 'Update':
                                    echo __('Update Recommendation', true);
                                    break;
                                default:
                                case 'Error':
                                    echo __('Error Recommendation', true);
                                    break;
                            }
                            ?>
                        </legend>

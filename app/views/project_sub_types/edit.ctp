...
<?php echo $this->Form->create('ProjectSubType');?>
	<fieldset>
		<legend><?php __('Edit Project Sub Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectSubType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectSubType.id'))); ?></li>

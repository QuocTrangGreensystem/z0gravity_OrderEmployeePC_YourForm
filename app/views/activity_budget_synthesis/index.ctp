...
<?php echo $html->css('activity_budget_synthesis'); ?>
    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            ...
            <div class="wd-list-project">
                <div class="wd-title">
                    <h2 class="wd-t1"><?php echo sprintf(__("Synthesis: %s", true), $activityName['Activity']['name']); ?></h2>
                ...
                <div class="wd-table" id="project_container" style="width:100%; height: auto;">
                    <table cellspacing="0" cellpadding="0" id="project-budget-table">
                        ...
                        <tr class="budget-title-total">
                            <td><?php echo __d(sprintf($_domain, 'Sales'), 'Total', true)?></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td class="td-numberic"><?php echo number_format($sale['sold'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($sale['billed'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($sale['billed_check'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($sale['paid'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td></td>
                    ...
                    <table cellspacing="0" cellpadding="0" id="project-budget-table">
                        ...
                        <tr class="budget-title-second">
                            ...
                            <td width="10%"><?php echo __('Forecast €', true)?></td>
                            <td width="10%"><?php echo __('Var %', true)?></td>
                            <td width="10%"><?php echo __('Engaged €', true)?></td>
                            <td width="10%"><?php echo __('Remain €', true)?></td>
                            <td width="10%" class="man-day-second"><?php echo __('M.D', true)?></td>
                            <td width="10%" class="none-using"></td>
                            <td width="10%" class="none-using"></td>
                        </tr>
                        <tr class="budget-title-total">
                            ...
                            <td id="total-forecast" class="td-numberic"></td>
                            <td id="total-var" class="td-numberic"></td>
                            <td id="total-engaged" class="td-numberic"></td>
                            <td id="total-remain" class="td-numberic"></td>
                    ...
                    <table cellspacing="0" cellpadding="0" id="project-budget-table">
                        ...
                        <tr class="budget-title-total">
                            <td><?php echo __d(sprintf($_domain, 'Internal_Cost'), 'Total', true)?></td>
                            <td></td>
                            <td class="td-numberic"><?php echo number_format($internals['budgetEuro'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($internals['forecastEuro'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($internals['varEuro'], 2, ',', ' ') . ' %';?></td>
                            <td class="td-numberic"><?php echo number_format($internals['engagedEuro'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td class="td-numberic"><?php echo number_format($internals['remainEuro'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                        ...
                        <tr>
                            ...
                            <td class="td-numberic"><?php echo number_format($internalDetail['budget_euro'], 2, ',', ' ') . ' '.$bg_currency;?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                    ...
                    <table cellspacing="0" cellpadding="0" id="project-budget-table">
                        ...
                        <tr class="budget-title-second">
                            ...
                            <td width="10%"><?php echo __d(sprintf($_domain, 'External_Cost'), 'Progress %', true)?></td>
                            <td width="10%"><?php echo __d(sprintf($_domain, 'External_Cost'), 'Progress €', true)?></td>
                        </tr>
                        <tr class="budget-title-total">
                            <td><?php echo __d(sprintf($_domain, 'External_Cost'), 'Total', true)?></td>
                            <td></td>
                            <td id="external-budget-euro" class="td-numberic"></td>
                            <td id="external-forecast-euro" class="td-numberic"></td>
                            <td id="external-var-euro" class="td-numberic"></td>
                            ...
                            <td id="external-progress" class="td-numberic"></td>
                            <td id="external-progress-euro" class="td-numberic"></td>
                        </tr>
                        <?php
                            if(!empty($externals)):
                                $md = __('M.D', true);
                        ...
                        <tr>
                            ...
                            <td class="td-numberic"><?php echo !empty($external['budget_erro']) ? number_format($external['budget_erro'], 2, ',', ' ') . ' '.$bg_currency : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['forecast_erro']) ? number_format($external['forecast_erro'], 2, ',', ' ') . ' '.$bg_currency : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['var_erro']) ? number_format($external['var_erro'], 2, ',', ' ') . ' %' : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['ordered_erro']) ? number_format($external['ordered_erro'], 2, ',', ' ') . ' '.$bg_currency : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['remain_erro']) ? number_format($external['remain_erro'], 2, ',', ' ') . ' '.$bg_currency : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['man_day']) ? number_format($external['man_day'], 2, ',', ' ') . ' ' . $md : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['progress_md']) ? number_format($external['progress_md'], 2, ',', ' ') . ' %' : '';?></td>
                            <td class="td-numberic"><?php echo !empty($external['progress_erro']) ? number_format($external['progress_erro'], 2, ',', ' ') . ' '.$bg_currency : '';?></td>
                        </tr>
                        <?php
                                endforeach;
                            endif;
...
<script type="text/javascript">
    ...
    (function($){
        $(function(){
            ...
            $totalCost_ForecastEuro = $totalForecastEuros + internals.forecastEuro;
            $totalCost_EngagedEuro = $totalOrderEuros + internals.engagedEuro;
            $totalCost_RemainEuro = $totalRemainEuros + internals.remainEuro;
            $totalCost_ManDay = $totalManDayExternal + internals.forecastedManDay;
            $totalCost_VarEuro = (((($totalForecastEuros + internals.forecastEuro)/($totalBudgetEuros + internals.budgetEuro))-1)*100).toFixed(2);

...
foreach ($budgetExternals as $key=>$budgetExternal) {
    ...
    $data['capex_id'] = isset($capexTypes[$budgetExternal['ProjectBudgetExternal']['budget_type_id']]) && !empty($capexTypes[$budgetExternal['ProjectBudgetExternal']['budget_type_id']]) ? 'capex' : 'opex';

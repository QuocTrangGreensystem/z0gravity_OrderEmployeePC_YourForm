    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            <div class="wd-list-project">
                ...
                echo $this->Form->create('Import', array('id' => 'import-form', 'url' => array('controller' => 'employees', 'action' => 'save_file_import')));
                ?>
                <?php
                foreach ($records as $type => $record) : ?>
                    ...
                    <div class="import-fieldset">
                        ...
                        <?php if ($type === 'Create') : ?>
                            <a id="submit-create-export" class="export-excel-icon-all" href="javascript:void(0)"></a>
                            <a id="submit-create-do" class="btn btn-ok" href="javascript:void(0)"></a>
                        <?php endif; ?>
                        <?php if ($type === 'Update') : ?>
                            <a id="submit-update-export" class="export-excel-icon-all" href="javascript:void(0)"></a>

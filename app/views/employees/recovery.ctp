<?php
 ...
 echo $this->Form->create('Employee', array('id' => 'EmployeeLoginForm')); ?>
...
<div class="page-login__panel new">
	<ul class="page-login-lang">
		...
		?>
		<li>
			<a href="<?php echo $this->Html->url(array('?' => array('hl' => 'fr')));?>" class="btn page-login__lang-btn fr <?php echo ($langCode == 'fr' ? 'page-login__lang-btn--active' : ''); ?>"><?php __("FR") ?></a>
		</li>
		<li>
			<a href="<?php echo $this->Html->url(array('?' => array('hl' => 'en')));?>" class="btn page-login__lang-btn en <?php echo ($langCode == 'en' ? 'page-login__lang-btn--active' : ''); ?>"><?php __("EN") ?></a>
		</li>
		<li>
			<a href="<?php echo $this->Html->url(array('?' => array('hl' => 'vi')));?>" class="btn page-login__lang-btn vi <?php echo ($langCode == 'vi' ? 'page-login__lang-btn--active' : ''); ?>"><?php __("VI") ?></a>
		</li>
	</ul>
    ...
    <div class="page-login__input input-recovery">
        ...
        <label for="EmployeeEmail"><?php __("Your e-mail address") ?></label>
    ...
    <a href="<?php echo $this->Html->url('/login'); ?>" class="page-login__lost-password"><?php __("Back To Home") ?></a>
	<?php 	
		$date = getdate();

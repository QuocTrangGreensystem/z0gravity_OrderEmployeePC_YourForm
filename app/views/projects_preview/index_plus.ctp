    ...
    <div class="list-type-project">
		<div class="wd-dropdown">
			...
			<div class="popup-dropdown">
				<?php 
				echo $this->Form->create('typeProject', array('id' => 'typeProjectForm', 'url' => array('controller' => $this->params['controller'], 'action' => $this->params['action'], 1)) );
				?>
				<ul class="list">
				<?php 
				foreach ($listProgramFields as $key => $value){
                    ...
                    <div class="wd-custom-checkbox">
                        <label> 
                            <input type="checkbox" class="checkbox" id="typeProjectProjectAmrProgram<?php echo $key;?>" name="typeProject[]" <?php if(in_array($key, $prog)) echo 'checked=checked';?> value="<?php echo $key;?>"/>
             ...
             $i = 0; foreach ($listProjects as $listProject) { ?>
                <?php foreach ($listProject as $project) { ?>
                    ...
                    <div class='portfolio-item-inner'>
                        <?php
                        $isDoc = false;
                        $link = $this->Html->url(array('controller' => 'project_global_views', 'action' => 'attachment_index', $project['Project']['id'], '?' => array('sid' => $api_key)), true);
                            ...
                            <div class="project-item-weather <?php echo $class; ?> ">
                                ...
                                <div class="project-item-list-action">
                                    <ul class="list-inline">
                                        ...
                                        <?php if( !empty($screenDashboard)){ 
											$_title = $_linkDashboard['title'];
										?>
										<li><a target="_blank" href="<?php echo $_linkDashboard['link'].'/'.$project['Project']['id']; ?>"><img title="<?php echo $_title;?>" src="<?php echo $html->url('/img/new-icon/dashboard.png'); ?>"/></a></li>
										<?php } ?> 
...
$('#CategoryCategory').change(function(){
    location.href = '<?php echo $this->Html->url('/projects_preview/index_plus/') ?>' + $(this).val() +'?view=new';
});
$('#project-program').change(function(){
    location.href = '<?php echo $this->Html->url('/projects_preview/index_plus/') ?>p-' + $(this).val() +'?view=new';
});
...
(function($){
    ...
    search_button.on('click', function(e){
        ...
        location.href = '<?php echo $this->Html->url('/projects_preview/index_plus/')?>' + param +'?view=new';

...
<?php
	...
	$columns = array(
		...
		'amr_organization' => array(
			'id' => 'amr_organization',
			'field' => 'amr_organization',
			'name' => __('ARM Organization', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrOrganizations as $projectAmrOrgani){
		if ($projectAmrOrgani['ProjectAmrOrganization']['company_id'] != "") {
			$company_id_save = $projectAmrOrgani['ProjectAmrOrganization']['company_id'];
		...
		$row_data = array(
			'id' => $projectAmrOrgani['ProjectAmrOrganization']['id'],
			'no' => $i++,
			'amr_organization' => $projectAmrOrgani['ProjectAmrOrganization']['amr_organization'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_organization		 : {defaulValue : '', allowEmpty : false},

...
<?php
	...
	$columns = array(
		...
		'risk_occurrence' => array(
			'id' => 'risk_occurrence',
			'field' => 'risk_occurrence',
			'name' => __('Risk Occurrence', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectRiskOccurrences as $projectRiskOccurrence){
		if ($projectRiskOccurrence['ProjectRiskOccurrence']['company_id'] != "") {
			$company_id_save = $projectRiskOccurrence['ProjectRiskOccurrence']['company_id'];
		...
		$row_data = array(
			'id' => $projectRiskOccurrence['ProjectRiskOccurrence']['id'],
			'no' => $i++,
			'risk_occurrence' => $projectRiskOccurrence['ProjectRiskOccurrence']['risk_occurrence'],		
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				risk_occurrence : {defaulValue : '', allowEmpty : false},

...
<?php echo $this->Form->create('ProjectRisk');?>
	<fieldset>
		<legend><?php __('Edit Project Risk'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectRisk.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectRisk.id'))); ?></li>

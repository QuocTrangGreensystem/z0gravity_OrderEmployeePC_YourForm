...
<?php
	...
	$dataView = array();
	$i = 1;
	foreach ($projectEvolutionImpacts as $projectEvolutionImpact){
		if ($projectEvolutionImpact['ProjectEvolutionImpact']['company_id'] != "") {
			$company_id_save = $projectEvolutionImpact['ProjectEvolutionImpact']['company_id'];
		...
		$row_data = array(
			'id' => $projectEvolutionImpact['ProjectEvolutionImpact']['id'],
			'no' => $i++,
			'evolution_impact' => $projectEvolutionImpact['ProjectEvolutionImpact']['evolution_impact'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				evolution_impact : {defaulValue : '', allowEmpty : false},

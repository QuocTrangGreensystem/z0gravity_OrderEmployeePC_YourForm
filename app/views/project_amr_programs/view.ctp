<div class="projectAmrPrograms view">
<h2><?php  __('Project Amr Program');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrProgram['ProjectAmrProgram']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Program'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrProgram['ProjectAmrProgram']['amr_program']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Program', true), array('action' => 'edit', $projectAmrProgram['ProjectAmrProgram']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Program', true), array('action' => 'delete', $projectAmrProgram['ProjectAmrProgram']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrProgram['ProjectAmrProgram']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Programs', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Program', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrProgram['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrProgram['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

...
<div id="wd-main">
    ...
    <div class="wd-left">
        <ul>
            ...
            <li class="wd-current-li"><?php echo __('Step 1: Choose Language', true);?></li>
   	...
   	<?php
    echo $this->Form->create('language', array('url' => array('controller' => 'installs', 'action' => 'language')));
    ?>
    <div id="gantt-display">
        <?php
        echo $this->Form->input('display', array(
            'options' => array(__('English (US)', true), __('French', true)),

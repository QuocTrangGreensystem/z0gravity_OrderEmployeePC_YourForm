...
<?php
	...
	foreach ($list as $val){
		$row_data = array(
			'id' => $val['ExpectationDataset']['id'],
			'no' => $i++,
			'eng' => $val['ExpectationDataset']['eng'],
			'fre' => $val['ExpectationDataset']['fre'],
			'dataset_name' => $val['ExpectationDataset']['dataset_name'],
			'display' => $val['ExpectationDataset']['display'] ? 'yes' : 'no',			
			'company_id' => $val['ExpectationDataset']['company_id']
		);
		$dataView[] = $row_data;
	}
	$i18n = array(
...
(function($){
	$(function(){
        ...
        $this.fields = {
            id : {defaulValue : 0},
            eng : {defaulValue : '', allowEmpty : false},
            fre : {defaulValue : '', allowEmpty : false},
			display : {defaulValue : '', allowEmpty : false},
			dataset_name : {defaulValue : current_dataset, allowEmpty : true},
            company_id : {defaulValue : current_company, allowEmpty : true}
        };

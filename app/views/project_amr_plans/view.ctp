<div class="projectAmrPlans view">
<h2><?php  __('Project Amr Plan');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrPlan['ProjectAmrPlan']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Plan'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrPlan['ProjectAmrPlan']['amr_plan']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Plan', true), array('action' => 'edit', $projectAmrPlan['ProjectAmrPlan']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Plan', true), array('action' => 'delete', $projectAmrPlan['ProjectAmrPlan']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrPlan['ProjectAmrPlan']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Plans', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Plan', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrPlan['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrPlan['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

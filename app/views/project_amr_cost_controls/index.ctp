...
<?php
	...
	$columns = array(
		...
		'amr_cost_control' => array(
			'id' => 'amr_cost_control',
			'field' => 'amr_cost_control',
			'name' => __('AMR Cost Control', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrCostControls as $projectAmrCostControl){
		if ($projectAmrCostControl['ProjectAmrCostControl']['company_id'] != "") {
			$company_id_save = $projectAmrCostControl['ProjectAmrCostControl']['company_id'];
		...
		$row_data = array(
			'id' => $projectAmrCostControl['ProjectAmrCostControl']['id'],
			'no' => $i++,
			'amr_cost_control' => $projectAmrCostControl['ProjectAmrCostControl']['amr_cost_control'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_cost_control : {defaulValue : '', allowEmpty : false},

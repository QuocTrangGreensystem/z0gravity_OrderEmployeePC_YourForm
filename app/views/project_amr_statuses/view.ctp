<div class="projectAmrStatuses view">
<h2><?php  __('Project Amr Status');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrStatus['ProjectAmrStatus']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Status'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrStatus['ProjectAmrStatus']['amr_status']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Status', true), array('action' => 'edit', $projectAmrStatus['ProjectAmrStatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Status', true), array('action' => 'delete', $projectAmrStatus['ProjectAmrStatus']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrStatus['ProjectAmrStatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Statuses', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Status', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrStatus['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrStatus['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

...
<?php
	...
	foreach ($currencies as $currencie){
		if ($currencie['Currency']['company_id'] != "") {
			$company_id_save = $currencie['Currency']['company_id'];
		...
		$row_data = array(
			'id' => $currencie['Currency']['id'],
			'no' => $i++,
			'sign_currency' => $currencie['Currency']['sign_currency'],
			'description' => $currencie['Currency']['description'],	
...
(function($){
	$(function(){
        ...
        $this.fields = {
            id : {defaulValue : 0},
            sign_currency : {defaulValue : '', allowEmpty : false},

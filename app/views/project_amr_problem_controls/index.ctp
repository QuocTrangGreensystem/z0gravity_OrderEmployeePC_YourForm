...
<?php
	...
	$columns = array(
		...
		'amr_problem_control' => array(
			'id' => 'amr_problem_control',
			'field' => 'amr_problem_control',
			'name' => __('Problem', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrProblemControls as $projectAmrProblemControl){
		if ($projectAmrProblemControl['ProjectAmrProblemControl']['company_id'] != "") {
			$company_id_save = $projectAmrProblemControl['ProjectAmrProblemControl']['company_id'];
		...
		$row_data = array(
			'id' => $projectAmrProblemControl['ProjectAmrProblemControl']['id'],
			'no' => $i++,
			'amr_problem_control' => $projectAmrProblemControl['ProjectAmrProblemControl']['amr_problem_control'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_problem_control: {defaulValue : '', allowEmpty : false},

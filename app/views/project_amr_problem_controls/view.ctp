<div class="projectAmrProblemControls view">
<h2><?php  __('Project Amr Problem Control');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrProblemControl['ProjectAmrProblemControl']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Problem Control'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrProblemControl['ProjectAmrProblemControl']['amr_problem_control']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Problem Control', true), array('action' => 'edit', $projectAmrProblemControl['ProjectAmrProblemControl']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Problem Control', true), array('action' => 'delete', $projectAmrProblemControl['ProjectAmrProblemControl']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrProblemControl['ProjectAmrProblemControl']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Problem Controls', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Problem Control', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrProblemControl['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrProblemControl['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

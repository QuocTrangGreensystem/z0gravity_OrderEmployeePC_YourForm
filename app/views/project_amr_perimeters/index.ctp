...
<?php
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrPerimeters as $projectAmrPerimeter){
		if ($projectAmrPerimeter['ProjectAmrPerimeter']['company_id'] != "") {
			$company_id_save = $projectAmrPerimeter['ProjectAmrPerimeter']['company_id'];
		...
		$row_data = array(
			'id' => $projectAmrPerimeter['ProjectAmrPerimeter']['id'],
			'no' => $i++,
			'amr_perimeter' => $projectAmrPerimeter['ProjectAmrPerimeter']['amr_perimeter'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_perimeter: {defaulValue : '', allowEmpty : false},

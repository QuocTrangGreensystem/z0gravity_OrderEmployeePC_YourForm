<div class="projectAmrPerimeters view">
<h2><?php  __('Project Amr Perimeter');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrPerimeter['ProjectAmrPerimeter']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Perimeter'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrPerimeter['ProjectAmrPerimeter']['amr_perimeter']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Perimeter', true), array('action' => 'edit', $projectAmrPerimeter['ProjectAmrPerimeter']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Perimeter', true), array('action' => 'delete', $projectAmrPerimeter['ProjectAmrPerimeter']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrPerimeter['ProjectAmrPerimeter']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Perimeters', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Perimeter', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrPerimeter['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrPerimeter['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

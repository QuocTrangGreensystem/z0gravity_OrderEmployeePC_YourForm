...
<?php
	...
	foreach ($projectFunctions as $projectFunction){
		if ($projectFunction['ProjectFunction']['company_id'] != "") {
			$company_id_save = $projectFunction['ProjectFunction']['company_id'];
		...
		$row_data = array(
			'id' => $projectFunction['ProjectFunction']['id'],
			'no' => $i++,
			'name' => $projectFunction['ProjectFunction']['name'],		

...
<?php
	...
	$selectMaps = array(
		...
		'status' => array( 1 => __('In progress', true), 0 => __('Closed', true)),
	);
	$dataView = array();
	$i = 1;
	foreach ($projectIssueStatuses as $projectIssueStatus){
		if ($projectIssueStatus['ProjectIssueStatus']['company_id'] != "") {
			$company_id_save = $projectIssueStatus['ProjectIssueStatus']['company_id'];
		...
		$row_data = array(
			'id' => $projectIssueStatus['ProjectIssueStatus']['id'],
			'no' => $i++,
			'issue_status' => $projectIssueStatus['ProjectIssueStatus']['issue_status'],
			'status' => $projectIssueStatus['ProjectIssueStatus']['status'] ? 1 : 0,
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				issue_status : {defaulValue : '', allowEmpty : false},
				status : {defaulValue : '', allowEmpty : false},

...
// echo $html->script(array('html2canvas', 'jquery.html2canvas_v2_ajax'));
echo $html->script(array('html2canvas', 'jquery.html2canvas_v2_preview'));
...
if (empty($start) || empty($end)) {
    ...
    foreach ($nodes as $nodeId => $node) {
		...
		if(!empty($node)){
			...
			$this->GanttV2Preview->draw(null, null, null, null, null, null, null, null, 'parent', null, null);
		}

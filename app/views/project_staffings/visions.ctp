...
div#mcs_container .gantt-staff .gantt-title td{
    border-top-width: 1px;
}
.gantt-primary .gantt-node-head .gantt-num td >div,
.gantt-title.gantt-head td div{
	color: #fff;
}
.gantt-primary .gantt-node-head .gantt-head td >div,
.gantt-primary .gantt-node-head .gantt-num td >div{
	text-align: center;
}
.gantt-wrapper .dragger_container:last-child {
    top: auto !important;
    bottom: 10px !important;
}
#mcs1_container .gantt-chart-wrapper >.gantt:first-child{
	border-left: 1px solid #fff !important;
}
body .gantt-primary .gantt-head td{
	border-color: #fff;
                ...
                <div class="wd-panel" style="overflow: auto">
                    ...
                    <div class="wd-title">
                        ...
                        <div style="float: left; margin-right: 5px; margin-top: 2px;">
							...
							// deactivate theo yeu cau ticket 585
                    ...
                    <div class="wd-section" id="wd-fragment-1">
                        ...
                        <div class="wd-content">
                            <h2 class="vision-project" style="color: orange"><?php echo sprintf(__('%s', true), $projectName['Project']['project_name']); ?></h2>
                            ...
                            <div id="GanttChartDIV">
                                    ...
                                    if ($part) {
                                        if (empty($nodes[$part])) {
                                            $nodes[$part] = array(
                                                ...
                                                'predecessor' => '',
                                                'color' => '#000',
                                                'completed' => isset($partCompleted[$part]) ? $partCompleted[$part]['completed'] : 0,
                                                'assign' => ''
                                            );
                                            foreach ($unsetFields as $key => $field) {
                                                $nodes[$part][$key] = 0;
                                ...
                                if (empty($start) || empty($end)) {
                                    ...
                                    $this->GanttV2->create($type, $start, $end, $staffingCate == 'profit_plus' ? array() : $stones, true, 'd-m-Y', $staffingCate == 'profit_plus');
                                    if( $staffingCate != 'profit_plus' ){
                                        $line = array();
                                    ...
                                    echo $this->Html->scriptBlock('GanttData = ' . $this->GanttV2->drawStaffing2($staffingss, $employee_info, $budgetMdTeams, $freezeTeams, $staffingCate != 'profit_plus', $showType, $displayTeamPlus, $staffingCate == 'profile', $showAllPicture, $staffingCate == 'profit_plus'));
        ...
        $(document).ready(function(){
            function resizeScroll(){
                ...
                if( $col.length ){
                    ...
                    $("#mcs1_container .container").css('left', '0px');
                    dragger_container.children(".dragger.ui-draggable").css('left', '0px');
                    // var _width = $('#mcs1_container').width() - 18;
                    var _width = $('#mcs1_container').width();
        ...
        $('#CategoryCategory').change(function(){
            $('#CategoryCategory option').each(function(){
                if($(this).is(':selected')){
                    ...
                    window.location = ('<?php echo $html->url('/') ?>project_staffings/visions/'+_projectId+'/'+id);
                }
            });
        });

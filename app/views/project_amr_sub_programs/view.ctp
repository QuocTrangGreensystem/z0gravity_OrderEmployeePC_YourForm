<div class="projectAmrSubPrograms view">
<h2><?php  __('Project Amr Sub Program');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrSubProgram['ProjectAmrSubProgram']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Sub Program'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrSubProgram['ProjectAmrSubProgram']['amr_sub_program']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Project Amr Program'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($projectAmrSubProgram['ProjectAmrProgram']['id'], array('controller' => 'project_amr_programs', 'action' => 'view', $projectAmrSubProgram['ProjectAmrProgram']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Sub Program', true), array('action' => 'edit', $projectAmrSubProgram['ProjectAmrSubProgram']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Sub Program', true), array('action' => 'delete', $projectAmrSubProgram['ProjectAmrSubProgram']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrSubProgram['ProjectAmrSubProgram']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Sub Programs', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Sub Program', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrSubProgram['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrSubProgram['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

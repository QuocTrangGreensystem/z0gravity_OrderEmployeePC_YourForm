<div class="group-content">
    <h3 class="half-padding">
        <span><?php echo __d(sprintf($_domain, 'KPI'), 'To Do', true);?></span>
        <?php if(($canModified && !$_isProfile )|| ($_isProfile && $_canWrite)):?>
            <span><a href="javascript:void(0);" id="add-activity" class="new_log" onclick="addLog('#todo-log')"></a></span>
        <?php endif;?>
    </h3>
    <div id="todo-log" class="kpi-log">
        <ul>
            <?php if(($canModified && !$_isProfile )|| ($_isProfile && $_canWrite)):
            ...
            <li class="new-log" data-log-id="">
                ...
                <div class="log-body">
                    ...
                    <textarea class="log-content" rowspan="2" onfocus="autosize(this)" onblur="autosize.destroy(this)" onchange="updateLog.call(this, 'ToDo')"></textarea>
                </div>
            </li>
            <?php endif ?>
            <?php
                if(!empty($todos)){
                    foreach($todos as $logSystem){
            ...
            ?>
            <li id="todo-<?php echo $logSystem['id'] ?>" data-log-id="<?php echo $logSystem['id'] ?>">
                ...
                <div class="log-body">
                    ...
                    <textarea class="log-content" rowspan="2" onfocus="autosize(this)" onblur="autosize.destroy(this)" <?php echo !(($canModified && !$_isProfile )|| ($_isProfile && $_canWrite)) ? 'disabled' : '' ?> onchange="updateLog.call(this, 'ToDo')"><?php echo $logSystem['description'] ?></textarea>
                </div>
            </li>
            <?php
                    }

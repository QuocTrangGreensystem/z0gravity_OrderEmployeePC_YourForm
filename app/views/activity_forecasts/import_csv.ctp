    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            <div class="wd-list-project">
                ...
                echo $this->Form->create('Import', array('id' => 'import-form', 'url' => array('controller' => 'activity_forecasts', 'action' => 'save_file_import', $setValid, $setStartDate, $setEndDate, $setEmployee)));
                ?>
                <?php 

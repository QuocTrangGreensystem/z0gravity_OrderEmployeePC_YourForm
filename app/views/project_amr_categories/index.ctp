...
<?php
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrCategories as $ProjectAmrCategory){
		if ($ProjectAmrCategory['ProjectAmrCategory']['company_id'] != "") {
			$company_id_save = $ProjectAmrCategory['ProjectAmrCategory']['company_id'];
		...
		$row_data = array(
			'id' => $ProjectAmrCategory['ProjectAmrCategory']['id'],
			'no' => $i++,
			'amr_category' => $ProjectAmrCategory['ProjectAmrCategory']['amr_category'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_category : {defaulValue : '', allowEmpty : false},

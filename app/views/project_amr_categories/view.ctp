<div class="projectAmrCategories view">
<h2><?php  __('Project Amr Category');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrCategory['ProjectAmrCategory']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Category'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrCategory['ProjectAmrCategory']['amr_category']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Category', true), array('action' => 'edit', $projectAmrCategory['ProjectAmrCategory']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Category', true), array('action' => 'delete', $projectAmrCategory['ProjectAmrCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrCategory['ProjectAmrCategory']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Categories', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Category', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrCategory['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrCategory['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

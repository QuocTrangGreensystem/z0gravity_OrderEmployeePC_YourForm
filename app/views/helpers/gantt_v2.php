 ...
 *
 */
class GanttV2Helper extends AppHelper {
                ...
                if ($_d > $_days) {
                    ...
                    if ($type == 'month') {
                        if($_m == 12 || $i >= $total-$step){
                            $head.="<td colspan=\"$_m_of_y\" class=\"gantt-year\"><div class='abs-title'>$_y</div></td>";
                            $_m_of_y = 1;
                        }else{
                            $_m_of_y++;
                        }
        ...
        $chart .= "<table class=\"gantt gantt-primary\">
            <tr>
                <td class=\"gantt-node gantt-node-head\">
                        <table>";
        $chart.= "<tr class=\"gantt-head huynh\">$head</tr>";
...
//    }
    ...
    public function drawStaffing($staffings, $displaySummary = true, $showType = false) {
        ...
        $titles = "<tr class=\"gantt-title gantt-head huynh\">$titles</tr>";
        ...
        foreach ($staffings as $key => $staffing) {
            ...
            if($showType == false){
                ...
                if( $showAllPicture && $staffing['id'] != 'summary' && $staffing['id'] != '999999999' ){
                    ...
                    $_name .= "<span class='circle-name'><img style='float:right; width:30px; height:30px;margin-right: 20px; margin-top: -5px;' src='" . $avatarEmploy . "'></span>";
                }
                $_name .= "</div>";
            } else {
            ...
            if ($titles) {
                $titles.= "<td><div>Total</div></td>";
                $titles = "<tr class=\"gantt-title gantt-head huynh gantt-head huynher\">$titles</tr>";
            }

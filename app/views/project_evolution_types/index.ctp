...
<?php
	...
	$columns = array(
		...
		'project_type_evolution' => array(
			...
			'field' => 'project_type_evolution',
			'name' => __('Project Evolution Type', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectEvolutionTypes as $projectEvolutionType){
		if ($projectEvolutionType['ProjectEvolutionType']['company_id'] != "") {
			$company_id_save = $projectEvolutionType['ProjectEvolutionType']['company_id'];
		...
		$row_data = array(
			'id' => $projectEvolutionType['ProjectEvolutionType']['id'],
			'no' => $i++,
			'project_type_evolution' => $projectEvolutionType['ProjectEvolutionType']['project_type_evolution'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				project_type_evolution : {defaulValue : '', allowEmpty : false},

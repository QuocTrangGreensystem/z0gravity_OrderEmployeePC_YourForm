                ...
                <div class="wd-tab">
                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
							...
							<p> Have <?php echo count($listTaskDelete);?> sub NCT tasks consumed=0, workload=0 in  <?php echo count($listNameProjects);?> projects</p>
							<?php echo $this->Form->create('Company', array(
							'type' => 'POST',
							'class' => 'list_companies',
							'url' => array("controller" => "recycle_bins", "action" => "deleteSubSubNctTask"))); ?>
...
<script>
   ...
   $('#CompanyRemoveSubTaskNctForm').on('submit', function(e){
		e.preventDefault();
		if (confirm('<?php echo __("Are you sure delete all subs task nct with Workload = 0 and Consumed = 0 ?", true); ?>') == false){
			return;
		};

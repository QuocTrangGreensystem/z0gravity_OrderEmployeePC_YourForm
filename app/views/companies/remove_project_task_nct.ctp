                ...
                <div class="wd-tab">
                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
							...
							'url' => array("controller" => "recycle_bins", "action" => "deleteOldNctTask"))); ?>
...
<script>
   ...
   $('#CompanyRemoveProjectTaskNctForm').on('submit', function(e){
		e.preventDefault();
		if (confirm('<?php echo __("Are you sure delete all NCT task with Workload = 0 and Consumed = 0 ?", true); ?>') == false){
			return;
		};

...
<?php
	...
	$columns = array(
		...
		'amr_risk_control' => array(
			'id' => 'amr_risk_control',
			'field' => 'amr_risk_control',
			'name' => __('ARM Risk Control', true),
			'width' => 300,
			'sortable' => true,
			'resizable' => true,
	...
	$dataView = array();
	$i = 1;
	foreach ($projectAmrRiskControls as $projectAmrRiskControl){
		if ($projectAmrRiskControl['ProjectAmrRiskControl']['company_id'] != "") {
			$company_id_save = $projectAmrRiskControl['ProjectAmrRiskControl']['company_id'];
		...
		$row_data = array(
			'id' => $projectAmrRiskControl['ProjectAmrRiskControl']['id'],
			'no' => $i++,
			'amr_risk_control' => $projectAmrRiskControl['ProjectAmrRiskControl']['amr_risk_control'],
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				amr_risk_control: {defaulValue : '', allowEmpty : false},

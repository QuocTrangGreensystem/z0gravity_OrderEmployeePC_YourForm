<div class="projectAmrRiskControls view">
<h2><?php  __('Project Amr Risk Control');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrRiskControl['ProjectAmrRiskControl']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Amr Risk Control'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $projectAmrRiskControl['ProjectAmrRiskControl']['amr_risk_control']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Project Amr Risk Control', true), array('action' => 'edit', $projectAmrRiskControl['ProjectAmrRiskControl']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Project Amr Risk Control', true), array('action' => 'delete', $projectAmrRiskControl['ProjectAmrRiskControl']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $projectAmrRiskControl['ProjectAmrRiskControl']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Project Amr Risk Controls', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Project Amr Risk Control', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($projectAmrRiskControl['ProjectAmr'])):?>
	...
	<?php
		$i = 0;
		foreach ($projectAmrRiskControl['ProjectAmr'] as $projectAmr):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

...
<?php echo $this->Form->create('ProjectPhasePlan');?>
	<fieldset>
		<legend><?php __('Edit Project Phase Plan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectPhasePlan.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectPhasePlan.id'))); ?></li>

...
<?php
	...
	$dataView = array();
	$i = 1;
	foreach ($projectRiskSeverities as $projectRiskSeverity){
		if ($projectRiskSeverity['ProjectRiskSeverity']['company_id'] != "") {
			$company_id_save = $projectRiskSeverity['ProjectRiskSeverity']['company_id'];
		...
		$row_data = array(
			'id' => $projectRiskSeverity['ProjectRiskSeverity']['id'],
			'no' => $i++,
			'risk_severity' => $projectRiskSeverity['ProjectRiskSeverity']['risk_severity'],			
...
<script>
	...
	(function($){
		$(function(){
			...
			$this.fields = {
				id : {defaulValue : 0},
				risk_severity : {defaulValue : '', allowEmpty : false},

    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            <div class="wd-list-project">
                <div class="wd-title">
                    <h2 class="wd-t1"><?php echo $activityName['Activity']['name'] ?></h2>
                </div>
                <div id="table-control">
                    ...
                    <fieldset>
                        ...
                        <div class="input">
                            <?php
                                echo $this->Form->input('start', array('label' => false, 'div' => false, 'style' => 'padding: 7px',  "class" => "placeholder", "placeholder" => __("(dd-mm-yyyy)", true), 'onchange' => "validated(this);", 'value' => isset($_start) ? date('d-m-Y', $_start) : ''));
                            ?>
                        </div>
                        <label><?php __('To') ?></label>
                        <div id="wd-group" style="margin-right: 5px; overflow: hidden; float: left">
                            <div class="input">
                                <?php
                                    echo $this->Form->input('end', array('label' => false, 'div' => false, 'style' => 'padding: 7px',  "class" => "placeholder", "placeholder" => __("(dd-mm-yyyy)", true), 'onchange' => "validated(this);", 'value' => isset($_end) ? date('d-m-Y', $_end) : ''));
                                ?>
                            </div>
                ...
                <div id="absence-container" style="width:100%;overflow-y: hidden;overflow-x: auto;">
                    <table id="absence">
                        <!-- this is the head of the table -->
                        <thead>
                            <tr>
                                <th rowspan="3" style="min-width: 40px"><?php __('#'); ?></th>
                                <th rowspan="3" style="min-width: 150px"><?php __('Employee'); ?></th>
                                <?php
                                $columns = array();
                                ...
                                while ($y < $_maxYear || ($y == $_maxYear && $m <= $_maxMonth)) {
                                    ...
                                    $_tem .= '<th style="min-width: 80px">' . __('Validated', true) . '</th><th style="min-width: 80px">' . __('Not Validated', true) . '</th>';

    ...
    <div class="wd-layout">
        <div class="wd-main-content">
            <div class="wd-list-project">
                <div class="wd-title">
                    <h2 class="wd-t1"><?php echo sprintf(__("Activity Detail of %s", true), $activityName['Activity']['name']); ?></h2>
                ...
                <div class="wd-table" id="project_container" style="width:100%;overflow-y: hidden;overflow-x: auto;">
                    <div id="absence-container" style="min-height:400px;">
                        <div id="absence-wrapper" class="absence-wrapper-scroll">
                            <table id="absence" style="width: auto;min-width: 34%;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        $_output = '';
                                        $_tem = '';
                                        $_tem .= '<th>' . __('Validated', true) . '</th><th>' . __('Not Validated', true) . '</th>';
                                ...
                                <tbody id="absence-table">
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $y = isset($_minYear) ? $_minYear : (isset($_start) ? date('Y', $_start) : 0);
                                            $_totalValidate = $_totalNotValidate = 0;
                                            ...
                                            while ($y < $_maxYear || ($y == $_maxYear && $m <= $_maxMonth)) {
                                                ...
                                                if(isset($profitCentersData['summary'][$y . '-' . $m])){
                                                    ...
                                                    $cell_outputs[] =
                                                    '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month">' .round($profitCentersData['summary'][$y . '-' . $m], 2). '</td>'.
                                                    '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month">' .$profitCentersDataNotValidate['summary'][$y . '-' . $m]. '</td>';
                                                    //
                                                    $_totalValidate += $profitCentersData['summary'][$y . '-' . $m];
                                                    //
                                                    $_totalNotValidate += $profitCentersDataNotValidate['summary'][$y . '-' . $m];
                                                }else{
                                                    $cell_outputs[] =
                                                    '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month">0</td>'.
                                                    '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month">0</td>';
                                                }
                                                $m++;
                                                if ($m == 13) {
                                            ...
                                            $_cell_outputs = '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month validate">' .round($_totalValidate, 2). '</td>'.
                                            '<td style="background-color: rgb(152, 187, 231) !important; vertical-align: middle;" class="month not-validate">' .$_totalNotValidate. '</td>';
                                        ?>
                                        <?php echo $_cell_outputs ?>
                                        <!-- echo the summary td -->
                                            ...
                                            <?php
                                                ...
                                                while ($y < $_maxYear || ($y == $_maxYear && $m <= $_maxMonth)) {
                                                    ...
                                                    if(isset($profitCentersData[$key][$y . '-' . $m]) || isset($profitCentersDataNotValidate[$key][$y . '-' . $m])){
                                                        ...
                                                        $cell_outputs[] =
                                                        '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month">' .round($profitCentersData[$key][$y . '-' . $m], 2). '</td>'.
                                                        '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month">' . $profitCentersDataNotValidate[$key][$y . '-' . $m] . '</td>'
                                                        ;
                                                        //
                                                        $_totalValidate += $profitCentersData[$key][$y . '-' . $m];
                                                        //
                                                        $_totalNotValidate += $profitCentersDataNotValidate[$key][$y . '-' . $m];
                                                    }else{
                                                        $cell_outputs[] =
                                                        '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month">0</td>'.
                                                        '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month">0</td>'
                                                        ;
                                                    }
                                                    $m++;
                                                ...
                                                $_cell_outputs = '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month validate">' .round($_totalValidate, 2). '</td>'.
                                                '<td style="background-color: #E8F0FA !important; vertical-align: middle;" class="month not-validate">' .$_totalNotValidate. '</td>';
                                            ?>
                                            <?php echo $_cell_outputs ?>
                                            <!-- echo the summary td -->
                                            <?php foreach ($cell_outputs as $index => $cell_output): ?>
                                        ...
                                        foreach ($employees as $employee) : ?>
                                            ...
                                            <tr>
                                                ...
                                                while ($y < $_maxYear || ($y == $_maxYear && $m <= $_maxMonth)) {
                                                    ...
                                                    $cell_outputs[] = '<td style="vertical-align: middle;" class="month">' . round($_output, 2) . '</td>' . '<td style="vertical-align: middle;" class="month">' . $_outputNotValidate . '</td>';
                                                    //
                                                    $_totalValidate += $_output;
                                                    //
                                                    $_totalNotValidate += $_outputNotValidate;
                                                    $m++;
                                                    if ($m == 13) {
                                                        $m = 1;
                                                        $y++;
                                                ...
                                                $_cell_outputs = '<td style="vertical-align: middle;" class="month">' . round($_totalValidate, 2) . '</td>' . '<td style="vertical-align: middle;" class="month">' . $_totalNotValidate . '</td>';
                                                ?>
                                                <?php echo $_cell_outputs ?>

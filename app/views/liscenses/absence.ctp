                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
                            ...
                            <div class="wd-content">
                                <!-- <h2 class="wd-t3"><?php __('Absences License Management') ?></h2> -->
                                ...
                                <div id="wd-form">
                                    ...
                                    <?php
                                        echo $this->Form->create('Absences', array(
                                            'enctype' => 'multipart/form-data', 
                                            'url' => array('controller' => 'liscenses', 'action' => 'absence')
                                        ));
                                    ?>
                                    <?php echo $this->Form->input('key', array('type' => 'file', 'label' => false, 'div' => false));?>
                                    <?php
                                        echo $this->Form->end(array('label' => __('Save', true), 'disabled' => 'disabled', 'id' => 'absencesSB'));
                                    ?>
                                    <?php
                                        }
                                    ?> 
...
<script>
    $('#AbsencesKey').change(function(){
        var data = $('#AbsencesKey').val();
        if(data){
            $('#absencesSB').removeAttr('disabled');
        }
    });
</script>
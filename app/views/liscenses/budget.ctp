					...
					<div class="wd-panel">
						<div class="wd-section" id="wd-fragment-1">
							...
							<div class="wd-content">
								<!-- <h2 class="wd-t3"><?php __('Budgets License Management') ?></h2> -->
								...
								<div id="wd-form">
									...
									<?php
										echo $this->Form->create('Budget', array(
											...
											'url' => array('controller' => 'liscenses', 'action' => 'budget')
										));
									?>
									<?php echo $this->Form->input('key', array('type' => 'file', 'label' => false, 'div' => false));?>
									<?php
										echo $this->Form->end(array('label' => __('Save', true), 'disabled' => 'disabled', 'id' => 'budgetSB'));
									?>
									<?php
										}
									?> 
...
<script>
	$('#BudgetKey').change(function(){
		var data = $('#BudgetKey').val();
		if(data){
			$('#budgetSB').removeAttr('disabled');
		}
	});
</script>
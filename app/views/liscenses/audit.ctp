                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
                            ...
                            <div class="wd-content">
                                <!-- <h2 class="wd-t3"><?php __('Audits License Management') ?></h2> -->
                                ...
                                <div id="wd-form">
                                    ...
                                    <?php
                                        echo $this->Form->create('Audit', array(
                                            ...
                                            'url' => array('controller' => 'liscenses', 'action' => 'audit')
                                        ));
                                    ?>
                                    <?php echo $this->Form->input('key', array('type' => 'file', 'label' => false, 'div' => false));?>
                                    <?php
                                        echo $this->Form->end(array('label' => __('Save', true), 'disabled' => 'disabled', 'id' => 'auditSB'));
                                    ?>
                                    <?php
                                        }
                                    ?> 
...
<script>
    $('#AuditKey').change(function(){
        var data = $('#AuditKey').val();
        if(data){
            $('#auditSB').removeAttr('disabled');
        }
    });
</script>
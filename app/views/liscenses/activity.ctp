                    ...
                    <div class="wd-panel">
                        <div class="wd-section" id="wd-fragment-1">
                            ...
                            <div class="wd-content">
                                <!-- <h2 class="wd-t3"><?php __('Activity License Management') ?></h2> -->
                                ...
                                <div id="wd-form">
                                    ...
                                    <?php
                                        echo $this->Form->create('Activity', array(
                                            ...
                                            'url' => array('controller' => 'liscenses', 'action' => 'activity')
                                        ));
                                    ?>
                                    <?php echo $this->Form->input('key', array('type' => 'file', 'label' => false, 'div' => false));?>
                                    <?php
                                        echo $this->Form->end(array('label' => __('Save', true), 'disabled' => 'disabled', 'id' => 'activitySB'));
                                    ?>
                                    <?php
                                        }
                                    ?> 
...
<script>
    $('#ActivityKey').change(function(){
        var data = $('#ActivityKey').val();
        if(data){
            $('#activitySB').removeAttr('disabled');
        }
    });
</script>
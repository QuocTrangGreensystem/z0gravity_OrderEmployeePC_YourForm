...
<table id="pupop-task">
	...
	<tbody>
		...
		<tr>
			...
			<th class="val sum-total-workload"><span class="sum-all"></span>/<span class="sum-total"><?php echo $this->Number->format($manDay['ProjectBudgetExternal']['man_day'], array('places' => 2,'before' => '','escape' =>false,'decimals' => ',','thousands' => ''));?></span></th>

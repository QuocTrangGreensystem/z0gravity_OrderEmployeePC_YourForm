...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Z0G","Utiliser z0 Gravity","Manager les absences","I. Poser une absence","II. Poser une absence par délégation","III. Valider/Refuser une absence"],
    DREX_NODE_LINKS: ["index.htm","utiliser_z0_gravity.htm","manager_les_absences.htm","i__poser_une_absence.htm","ii__poser_une_absence_par_delegation.htm","iii__valider_refuser_une_absence.htm"],
    DREX_NODE_CHILD_START: [1,2,3,6,6,6],
    DREX_NODE_CHILD_END: [2,3,6,6,6,6],
    DREX_MENU_TYPE: 1,

...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Z0G","Utiliser z0 Gravity"," Manager une feuille de temps","I -  Remplir sa feuille de temps","II - Remplir une feuille de temps par délégation","III - Faire valider une feuille de temps","IV - Valider une feuille de temps","V - Rejet d\'une feuille de temps","VI. Visualiser les feuilles de temps non envoyées"],
    DREX_NODE_LINKS: ["index.htm","utiliser_z0_gravity.htm","_manager_une_feuille_de_temps.htm","i____remplir_sa_feuille_de_temps.htm","ii___remplir_une_feuille_de_temps_par_delegation.htm","iii___faire_valider_une_feuille_de_temps.htm","iv___valider_une_feuille_de_temps.htm","v___rejet_d_une_feuille_de_temps.htm","vi__visualiser_les_feuilles_de_temps_non_envoyees.htm"],
    DREX_NODE_CHILD_START: [1,2,3,9,9,9,9,9,9],
    DREX_NODE_CHILD_END: [2,3,9,9,9,9,9,9,9],
    DREX_MENU_TYPE: 1,

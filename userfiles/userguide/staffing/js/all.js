...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Z0G","Utiliser z0 Gravity","Le Staffing et plan de charge global"],
    DREX_NODE_LINKS: ["index.htm","utiliser_z0_gravity.htm","le_staffing_et_plan_de_charge_global.htm"],
    DREX_NODE_CHILD_START: [1,2,3],
    DREX_NODE_CHILD_END: [2,3,3],
    DREX_MENU_TYPE: 1,

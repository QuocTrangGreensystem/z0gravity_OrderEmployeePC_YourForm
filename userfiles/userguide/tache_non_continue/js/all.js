...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Z0G","Utiliser z0 Gravity","Créer une tâche non continue"],
    DREX_NODE_LINKS: ["index.htm","utiliser_z0_gravity.htm","creer_une_tache_non_continue.htm"],

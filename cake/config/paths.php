...
/**
 * Default paths to be overidden by new architecture 2016-03
 */

if( !defined('USERFILES') ){
	define('USERFILES', WWW_ROOT);
}
...
if( !defined('TEMPLATES') ){
	define('TEMPLATES', WWW_ROOT . 'templates' . DS);
}

if( !defined('KEYS') ){
	define('KEYS', WWW_ROOT . 'key' . DS);
}

if( !defined('SHARED') ){
	define('SHARED', WWW_ROOT . 'shared' . DS);
}
